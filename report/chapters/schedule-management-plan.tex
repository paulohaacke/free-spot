...
\begin{itemize}
	...
	\item A estimativa de tempo para cada atividade deve ser determinada utilizando a técnica de \foreign{Program, Evaluation and Review Technique} (PERT), conforme equação \ref{eq:time-pert}.
