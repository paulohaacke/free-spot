...
Com base nos requisitos coletados e aprovação por parte do patrocinador a definição do escopo será baseada nos seguintes documentos:
\begin{itemize}
	\item Declaração de escopo, considerando os requisitos formalizados e aprovados durante a coleta de requisitos. A declaração de escopo será elaborada e aprovada pelas partes inetressadas.
	\item EAP e dicionário da EAP para o escopo das atividades a serem realizadas, assim como as entregas definidas.
\end{itemize}

\section{Validar escopo}

O escopo será validado em reunião juntamente com o patrocinador do projeto. Sua aprovação será realizada mediante a assinatura do termo de aceite.

\section{Controlar o escopo}

O controle do escopo será realizado pelo gerente de projeto utilizando informações de desempenho do trabalho e comparando as mesmas com os documentos gerados na definição do escopo (linha de base do escopo). Deverão ser avaliados os desvios em relação a linha de base de escopo do projeto e identificadas as necessidades de ações corretivas ou preventivas.
