...
Os processos e ferramentas descritos neste plano envolvem a realização das atividades vistas na figura \ref{fig:cost-management-plan-flowchart}.
...
\end{itemize}
\todo[inline,color=red]{Verificar se custos indiretos serão incluídos no projeto.}
...
Uma reserva gerencial de 15\% do orçamento estará diponível para contemplar riscos desconhecidos e atividades não identificadas no escopo.
...
\todo[inline,color=red]{Tabela de autonomias do GP no plano de custos.}
