...
\begin{description}
	\item[IDC = 1] Projesto está atendendo as expectativas (dentro do orçamento).
	\item[IDC > 1] Projeto está superando as expectativas (gastando menos que o orçado).
	\item[IDC < 1] Projeto está abaixo das expectativas (gastando mais que o orçado).
\end{description}
