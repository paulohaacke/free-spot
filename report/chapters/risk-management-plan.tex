...
\todo[inline,color=red]{Preencher tabela VME.}
...
\begin{longtable}{ c p{0.4\textwidth} c c c }
	\toprule
...
As reservas de contingência totalizam \contingencyBudget{} \todo[inline,color=red]{Revisar valor de reservas de contingência.}, o gerente de projeto possui as autonomias descritas no plano de gerenciamento de custos para utilização das reservas.
