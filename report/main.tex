...
%\begin{fichacatalografica}
%	\sffamily
%	Ficha Catalográfica Temporária: deve ser substituída pela oficial.
...
%
%				\hspace{0.5cm} 172 p. : il. (algumas color.) ; 30 cm.\\
%
...
\begin{folhadeaprovacao}
	...
	Trabalho aprovado. \imprimirlocal, 31 de julho de 2017:

	\assinatura{\textbf{\imprimirorientador} \\ Orientador}
	\assinatura{\textbf{Prof. Osmar A. M. Pedrozo} \\ Avaliador}
	\assinatura{\textbf{Prof. Me. Fábio Giordani} \\ Avaliador}
...
\include{chapters/abstract-ptbr}

\include{chapters/abstract-enus}
...
\begin{siglas}
	...
	\item[PMBOK] \foreign{Project Management Body of Knowledge} (Um Guia do Conhecimento em Gerenciamento de Projetos)
...
\begin{apendicesenv}
	...
	%\include{chapters/market-survey}

	%\include{chapters/business-plan}

	\include{chapters/work-breakdown-structure}

	\include{chapters/wbs-dictionary}

	\include{chapters/gannt-chart}

	\include{chapters/cost-activities}

	\include{chapters/project-monitoring-report}

	\include{chapters/quality-checklists}

	\include{chapters/quality-metrics}

	\include{chapters/raci-matrix}

	\include{chapters/team-evaluation-form}

	\include{chapters/status-report}

	\include{chapters/stakeholder-communication-requirements}

	\include{chapters/stakeholder-classification}
	
	\include{chapters/question-register}

	\include{chapters/change-request-form}
